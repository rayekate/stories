...
const features = [
  {
    title: "AI Generation",
    description: "Powered by unconstrained large models, our studio transforms your text into rich, multi-layered adult narratives with full genre awareness.",
    icon: Brain,
    color: "bg-blue-500",
    glow: "bg-blue-500",
  },
  {
    ...
    description: "Continue the intimacy in real-time. Make choices that shape the future of your characters and craft private worlds through dialogue.",
    icon: Zap,
    color: "bg-amber-500",
    glow: "bg-amber-500",
  },
  {
    ...
    description: "From Dark Romance to Cyber-Noir, choose from 10 genre vectors and blend them for unique, unfiltered combinations.",
    icon: Palette,
    color: "bg-accent",
    glow: "bg-accent",
  },
  {
    title: "Secret Segments",
    description: "Build expansive, private scenarios across multiple chapters with persistent session memory management.",
    icon: Layers,
  ...
  {
    title: "Immersive UI",
    description: "A private, cinematic experience designed for focus. From writing to reading, every pixel is intentionally intimate.",
    icon: Box,
    color: "bg-purple-500",
    glow: "bg-purple-500",
  },
  {
    ...
    description: "Share your private generated experiences with an exclusive community of writers and narrative explorers.",
    icon: Share2,
    color: "bg-rose-500",
    glow: "bg-rose-500",
  },
  {
    title: "Export & Save",
    description: "Download your complete narratives as text files or copy them instantly. Your fantasies, your way.",
    icon: FileDown,
    color: "bg-teal-500",
    glow: "bg-teal-500",
  },
  {
    title: "Reading Mode",
    description: "A dedicated full-screen reading experience with adjustable typography to match your private preference.",
    icon: Moon,
    color: "bg-indigo-500",
    glow: "bg-indigo-500",
  },
